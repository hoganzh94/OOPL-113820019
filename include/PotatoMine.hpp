...
public:
    ...
    PotatoMine(glm::vec2 pos) : Plant(PlantType::POTATOMINE, pos, Config::POTATOMINE_HP) {
        ...
        SetDrawable(std::make_shared<Util::Image>(std::string(RESOURCE_DIR) + "/Image/Plant/Potato mine/Pop up/Potato Mine - Pop up 1.png"));
    }
    ...
    void Update() override {
        ...
        if (m_State == State::UNDERGROUND && m_Timer >= 15.0f) {
            ...
            popUpPaths.push_back(std::string(RESOURCE_DIR) + "/Image/Plant/Potato mine/Pop up/Potato Mine - Pop up 2.png");
            popUpPaths.push_back(std::string(RESOURCE_DIR) + "/Image/Plant/Potato mine/Pop up/Potato Mine - Pop up 3.png");
            ...
            idlePaths.push_back(std::string(RESOURCE_DIR) + "/Image/Plant/Potato mine/Idle/Potato mine - Idle 1.png");
            idlePaths.push_back(std::string(RESOURCE_DIR) + "/Image/Plant/Potato mine/Idle/Potato mine - Idle 2.png");
    ...
    void OnCollision(std::shared_ptr<Zombie> zombie) override {
        ...
        if (m_State == State::READY) {
            ...
            // 視覺：換成爆炸圖
            SetDrawable(std::make_shared<Util::Image>(std::string(RESOURCE_DIR) + "/Image/Plant/Potato mine/Potato Mine - Explosion.png"));
